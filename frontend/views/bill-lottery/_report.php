    ...
    <tr>
        <td>
            <div align="center">
                ...
                <p style="font-size: 5px">โปรโมชั่น: <?= $promotionLottery[0]['name'] ?></>
            </div>
        </td>
    </tr>
</table>
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    foreach ($buyLottery as $key => $value) {
        ...
        ?>
        <tr>
            <td align="center" <?= $key === 0 ? 'style="padding-top: 3px;"' : '' ?>>
                <p style="font-size: 5px"><?= $value['number']; ?></p>
            </td>
            <td align="center" <?= $key === 0 ? 'style="padding-top: 3px;"' : '' ?>>
                <p style="font-size: 5px"><?= $value['typeLottery']['name']; ?></p>
            </td>
            <td align="center" <?= $key === 0 ? 'style="padding-top: 3px;"' : '' ?> <?= $key === $lastKey ? 'style="border-bottom: 1px solid #000000;"' : '' ?>>
                <p style="font-size: 5px"><?= $value['moneyPlay']; ?></p>
            </td>
            <td align="center" <?= $key === 0 ? 'style="padding-top: 3px;"' : '' ?> <?= $key === $lastKey ? 'style="border-bottom: 1px solid #000000;"' : '' ?>>
                <p style="font-size: 5px"><?= $value['moneyPay']; ?></p>
            </td>
        </tr>
    <?php } ?>
    <tr>
